...
typedef struct
{
  ...
  __IO uint32_t ODR;      /*!< GPIO port output data register,        Address offset: 0x14      */ //Output data register 数据输出寄存器  //地址偏移量:0x14
  __IO uint16_t BSRRL;    /*!< GPIO port bit set/reset low register,  Address offset: 0x18      */ //port:端口
  __IO uint16_t BSRRH;    /*!< GPIO port bit set/reset high register, Address offset: 0x1A      */ //Bit Set Reset Register High
